...
alias ${DJAEIN_PROJECT_NAME_UNDERSCORE}_git_r="djaeinGitRebase $DJAEIN_PROJECT_NAME_UNDERSCORE "
alias ${DJAEIN_PROJECT_NAME_UNDERSCORE}_git_rd="djaeinGitRebase $DJAEIN_PROJECT_NAME_UNDERSCORE develop"
...
alias ${DJAEIN_PROJECT_NAME_UNDERSCORE}_run="djaeinDjangoRun $DJAEIN_PROJECT_NAME_UNDERSCORE $DJAEIN_PROJECT_NAME_UNDERSCORE $DJAEIN_LOCAL_PORT"
...
alias ${DJAEIN_PROJECT_NAME_UNDERSCORE}_ve_installs="djaeinDjangoDefaultSetup \"$DJAEIN_PROJECT_ROOT_FOLDER\" $DJAEIN_INIT_REQUIREMENTS_FILE_NAME $DJAEIN_PROJECT_NAME_UNDERSCORE"
